...
class MainContainer extends JPanel
{
    ...
    public MainContainer() {
        ...
        JButton submitButt = new CButton("LogIn");
        JButton resetButt = new CButton("Reset");
        add(submitButt, labCnst);
        add(resetButt, labCnst);
    }
...
public class WelcomeClient {
    ...
    public static void main(String[] args) throws IOException {
        ...
        MainContainer.textureImg = ImageIO.read(new File("./img/289-5757.jpg"));
